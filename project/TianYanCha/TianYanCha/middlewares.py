...
# from TianYanCha.get_proxies import Proxies
import time
...
class MyproxiesSpiderMiddleware(object):
    ...
    # 线程代理 多数无效
    # def __init__(self):
    #     self.proxy_object = Proxies()
    #     self.proxy_object.get_begin()
    #     # 等待代理入队
    #     time.sleep(2)
    #
    # # 每次请求都换代理
    # def process_request(self, request, spider):
    #     try:
    #         proxies = self.proxy_object.get_useful_proxies()
    #         if proxies:
    #             print("获取到代理IP： %s" % proxies['https'])
